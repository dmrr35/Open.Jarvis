...
from jarvis import set_ui_callback, start_jarvis
from llm_fallback import describe_ai_status
from observability import build_latency_snapshot, build_slo_report
from permission_profiles import get_active_permission_profile
from ui_hud_effects import (
...
from ui_log_events import infer_log_kind, normalize_log_event
from ui_navigation import build_sidebar, refresh_sidebar
from ui_onboarding import show_onboarding
from ui_pages import PAGE_TITLES, build_info_page, refresh_info_pages
from ui_rendering import draw_hologram_figure
from ui_state import get_state_profile, infer_state_from_message
